...
public class BaggageHandlerDashboardController implements Initializable {
    ...
    @FXML    private Button searchPassengerButton;
    @FXML    private Button addBaggage;
    @FXML    private Button viewBaggage;
...
//            Logger.getLogger(EmployeeDashboardController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void adminDashboardButtonOnClick(MouseEvent event) throws IOException {
            Parent r = FXMLLoader.load(getClass().getResource("BaggageHandlerDashboard.fxml"));
    ...
    public void dashboard(String u){
        ...
        try {
            ...
            while(sc.hasNextLine()){
                ...
                if(data.get(1).equals(u)  && data.get(7).equals("Baggage Handler")){
    ...
    @FXML
    private void searchPassengerButtonOnCLick(MouseEvent event) {
        loadUI("ViewPassenger");
    }
    
    @FXML
    private void addBaggageButtonOnCLick(MouseEvent event) {
        loadUI("BaggageHandler");
    }
    
    @FXML
    private void viewBaggageButtonOnCLick(MouseEvent event) {
        loadUI("ViewBaggage");
    }
